...
random_state_value = 0#configs_list[rank][0]
min_support = 0.01#configs_list[rank][1]
max_depth = 10#configs_list[rank][2]
max_width = 1#configs_list[rank][3]
...
if dataset in ["compas", 'adult']:
    ...
    X = X.astype('int32')
    y = y.astype('int32')
    features, prediction = ["na" for i in range(X.shape[1])], "na"
