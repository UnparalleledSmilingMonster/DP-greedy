...
min_support_params = [0.01*i for i in range(1,2)] # minimum proportion of training examples that a rule (or a leaf) must capture
...
if rank == 0 or not ccanada_expes:
    # save results
    fileName = './results/%s_%s_second.csv' %(method, dataset) #_proportions
    import csv
