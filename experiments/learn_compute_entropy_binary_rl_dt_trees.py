...
parser.add_argument('--expe_id', type=int, default=0, choices= [0,1,2,3,4,5,6,7], help='method-dataset combination (for now, only COMPAS and tic-tac-toe supported)')
...
datasets = ["compas", "tic-tac-toe", "zoo-1", "vote"]
