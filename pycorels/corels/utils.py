    ...
    def __str__(self):
        ...
        if len(self.rules) == 1:
            ...
            for i in range(len(self.rules) - 1):
                ...
                tot += "if [" + feat + "]:\n  " + self.prediction_name + " = " + str(bool(self.rules[i]["prediction"])) + " " + str(self.rules[i]['train_labels']) + "\nelse "

            tot += "\n  " + self.prediction_name + " = " + str(bool(self.rules[-1]["prediction"])) + " " + str(self.rules[-1]['train_labels'])
